...
- [moul/bot](https://github.com/moul/bot) ([v1.9.9](https://github.com/moul/bot/releases/tag/v1.9.9), 2 days ago) - 🤖 my personal bot / virtual assistant (GitHub, Discord, HTTP&#43;gRPC API, Twitter, Coffee, etc)
...
- [moul/repoman](https://github.com/moul/repoman) ([v1.1.2](https://github.com/moul/repoman/releases/tag/v1.1.2), 2 weeks ago) - 📋 repo manager: some scripts I run against my repos
