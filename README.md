...
- [moul/zapring](https://github.com/moul/zapring) ([v1.2.0](https://github.com/moul/zapring/releases/tag/v1.2.0), 1 day ago) - 💍 In-memory RING buffer backend for the Zap logger
- [berty/berty](https://github.com/berty/berty) ([v2.263.0](https://github.com/berty/berty/releases/tag/v2.263.0), 1 day ago) - Berty is a secure peer-to-peer messaging app that works with or without internet access, cellular data or trust in the network
- [alta/protopatch](https://github.com/alta/protopatch) ([v0.3.3](https://github.com/alta/protopatch/releases/tag/v0.3.3), 1 day ago) - protoc-gen-go patch utility
