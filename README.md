...
- [moul/repoman](https://github.com/moul/repoman) ([v1.6.7](https://github.com/moul/repoman/releases/tag/v1.6.7), today) - 📋 repo manager: some scripts I run against my repos
- [moul/sshportal](https://github.com/moul/sshportal) ([v1.19.2](https://github.com/moul/sshportal/releases/tag/v1.19.2), today) - :tophat: simple, fun and transparent SSH (and telnet) bastion server
- [moul/alfred-workflow-u](https://github.com/moul/alfred-workflow-u) ([v1.5.5](https://github.com/moul/alfred-workflow-u/releases/tag/v1.5.5), today) - 🚧 useless Alfred workflow used as a test to find a good project structure
...
<details>
  ...
  <img src="https://img.shields.io/date/1644179641.svg?label=build&colorB=purple" />
