...
- [berty/berty](https://github.com/berty/berty) ([v2.302.6](https://github.com/berty/berty/releases/tag/v2.302.6), today) - Berty is a secure peer-to-peer messaging app that works with or without internet access, cellular data or trust in the network
- [uber-go/zap](https://github.com/uber-go/zap) ([v1.19.0](https://github.com/uber-go/zap/releases/tag/v1.19.0), 2 days ago) - Blazing fast, structured, leveled logging in Go.
...
<details>
  ...
  <img src="https://img.shields.io/date/1628712325.svg?label=build&colorB=purple" />
