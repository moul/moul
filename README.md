...
- [ultreme/camembert-au-lait-crew](https://github.com/ultreme/camembert-au-lait-crew) ([v1.1.0](https://github.com/ultreme/camembert-au-lait-crew/releases/tag/v1.1.0), 5 days ago) - :hamburger: Camembert au lait crew website &amp; API
- [moul/junk](https://github.com/moul/junk) ([v1.1.3](https://github.com/moul/junk/releases/tag/v1.1.3), 6 days ago) - :poop: Junk food :fist::frog::first_quarter_moon_with_face::squirrel::mega::mailbox::bulb::low_brightness::video_camera::calling::ski::dart::bikini::eggplant::barber::aquarius:
- [moul/alfred-workflow-u](https://github.com/moul/alfred-workflow-u) ([v1.5.7](https://github.com/moul/alfred-workflow-u/releases/tag/v1.5.7), 6 days ago) - 🚧 useless Alfred workflow used as a test to find a good project structure
...
<details>
  ...
  <img src="https://img.shields.io/date/1645297489.svg?label=build&colorB=purple" />
